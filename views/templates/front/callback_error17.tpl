...
{block name="page_content"}
  ...
  <p>{{l s='Please wait a short while then click on "Check again" below. If there is no change please %scontact us%s before placing another order so we can try to manually verify your payment.' mod='btcpay'}|sprintf:"<a href=\"{$link->getPageLink('contact')}\">":'</a>' nofilter}</p>
