...
{capture name=path}
  <a href="{$back_link|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='btcpay'}">{l s='Checkout' mod='btcpay'}</a><span class="navigation-pipe">{$navigationPipe|escape:'html':'UTF-8'}</span>{$heading|escape:'html':'UTF-8'}
{/capture}
