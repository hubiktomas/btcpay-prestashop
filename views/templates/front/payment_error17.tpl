...
{block name="page_content"}
  ...
  <p>
    {{l s='The raw response data is displayed below. Please %sforward this%s to the site administrator so that they may rectify the issue.' mod='btcpay'}|sprintf:"<a href=\"{$link->getPageLink('contact')}\" target=\"_blank\">":'</a>' nofilter}
  </p>
  <pre>{$error}</pre>
